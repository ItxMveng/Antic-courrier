...
// Récupérer les courriers envoyés par l'utilisateur connecté
$sent_mails = $db->prepare('SELECT ft.*, u.username as recipient_name FROM file_transfers ft JOIN users u ON ft.recipient_id = u.id WHERE ft.sender_id = ? ORDER BY ft.created_at DESC');
$sent_mails->execute([$_SESSION['id']]);
...
<body class="app">   	
  ...
  <circle cx="3.5" cy="10.5" r=".5"/>
		                         ...
		                         <span class="nav-link-text">Rediger Un Courriers</span>
					        </a><!--//nav-link-->
					    </li><!--//nav-item-->
...
<div class="app-wrapper">
	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
			...
			<div class="d-flex justify-content-between align-items-center mb-4">
                <h1 class="display-4">Ajouter Un Courrier</h1>
            </div>	<br><br> 
			<div class="d-flex flex-column align-items-start mb-3">
        <a href="test.php" class="btn btn-success mb-2" style="background-color: #28a745; border-color: #28a745;">
            Envoyer un courrier
        </a>
        <h2 class="mb-0">Courriers Envoyés</h2>
    </div>
    <table class="table table-striped table-bordered">
        ...
        <tbody>
            <?php while ($mail = $sent_mails->fetch(PDO::FETCH_ASSOC)) { ?>
                <tr>
                    <td><?= htmlspecialchars($mail['id']); ?></td>
                    <td><?= htmlspecialchars($mail['subject']); ?></td>
                    <td><?= htmlspecialchars($mail['recipient_name']); ?></td>
                    <td><?= htmlspecialchars($mail['created_at']); ?></td>
                    <td>
                        <a href="<?= htmlspecialchars($mail['file_path']); ?>" class="btn btn-info btn-sm" download style="background-color: #28a745; border-color: #28a745;">
                            Télécharger 
                        </a>
                    </td>
                </tr>
